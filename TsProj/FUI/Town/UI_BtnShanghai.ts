...
export default class UI_BtnShanghai {
	...
	public static URL:string = "ui://7d8qawjuq131j";
	public static Package:string  = "Town";
	public static Component:string  = "BtnShanghai";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_BtnShanghai.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_BtnShanghai {
		var obj = new UI_BtnShanghai();
		if(component==null){component = UI_BtnShanghai.CreateComponent(WorldContextObject);}
