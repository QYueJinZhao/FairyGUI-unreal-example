...
export default class UI_BtnHarbin {
	...
	public static URL:string = "ui://7d8qawjuq131i";
	public static Package:string  = "Town";
	public static Component:string  = "BtnHarbin";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_BtnHarbin.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_BtnHarbin {
		var obj = new UI_BtnHarbin();
		if(component==null){component = UI_BtnHarbin.CreateComponent(WorldContextObject);}
