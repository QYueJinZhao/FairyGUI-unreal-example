...
export default class UI_BtnUrumqi {
	...
	public static URL:string = "ui://7d8qawjuq131k";
	public static Package:string  = "Town";
	public static Component:string  = "BtnUrumqi";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_BtnUrumqi.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_BtnUrumqi {
		var obj = new UI_BtnUrumqi();
		if(component==null){component = UI_BtnUrumqi.CreateComponent(WorldContextObject);}
