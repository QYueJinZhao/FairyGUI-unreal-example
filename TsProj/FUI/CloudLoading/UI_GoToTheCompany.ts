...
export default class UI_GoToTheCompany {
	...
	public static URL:string = "ui://4pjqltd9rtxm41";
	public static Package:string  = "CloudLoading";
	public static Component:string  = "GoToTheCompany";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_GoToTheCompany.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_GoToTheCompany {
		var obj = new UI_GoToTheCompany();
		if(component==null){component = UI_GoToTheCompany.CreateComponent(WorldContextObject);}
