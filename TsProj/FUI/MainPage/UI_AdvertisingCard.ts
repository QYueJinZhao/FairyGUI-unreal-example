...
export default class UI_AdvertisingCard {
	...
	public static URL:string = "ui://sn18zihkdkz643";
	public static Package:string  = "MainPage";
	public static Component:string  = "AdvertisingCard";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_AdvertisingCard.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_AdvertisingCard {
		var obj = new UI_AdvertisingCard();
		if(component==null){component = UI_AdvertisingCard.CreateComponent(WorldContextObject);}
