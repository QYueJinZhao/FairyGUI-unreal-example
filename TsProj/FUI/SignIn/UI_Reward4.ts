...
export default class UI_Reward4 {
	...
	public static URL:string = "ui://h9dczuj89xrpo";
	public static Package:string  = "SignIn";
	public static Component:string  = "Reward4";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_Reward4.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_Reward4 {
		var obj = new UI_Reward4();
		if(component==null){component = UI_Reward4.CreateComponent(WorldContextObject);}
