...
export default class UI_Reward3 {
	...
	public static URL:string = "ui://h9dczuj89xrpn";
	public static Package:string  = "SignIn";
	public static Component:string  = "Reward3";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_Reward3.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_Reward3 {
		var obj = new UI_Reward3();
		if(component==null){component = UI_Reward3.CreateComponent(WorldContextObject);}
