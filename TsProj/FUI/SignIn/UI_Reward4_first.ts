...
export default class UI_Reward4_first {
	...
	public static URL:string = "ui://h9dczuj8daci4m";
	public static Package:string  = "SignIn";
	public static Component:string  = "Reward4_first";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_Reward4_first.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_Reward4_first {
		var obj = new UI_Reward4_first();
		if(component==null){component = UI_Reward4_first.CreateComponent(WorldContextObject);}
