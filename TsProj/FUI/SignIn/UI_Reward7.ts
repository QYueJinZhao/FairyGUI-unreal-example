...
export default class UI_Reward7 {
	...
	public static URL:string = "ui://h9dczuj89xrpr";
	public static Package:string  = "SignIn";
	public static Component:string  = "Reward7";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_Reward7.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_Reward7 {
		var obj = new UI_Reward7();
		if(component==null){component = UI_Reward7.CreateComponent(WorldContextObject);}
