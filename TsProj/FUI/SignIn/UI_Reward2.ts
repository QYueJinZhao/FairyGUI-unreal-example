...
export default class UI_Reward2 {
	...
	public static URL:string = "ui://h9dczuj89xrpm";
	public static Package:string  = "SignIn";
	public static Component:string  = "Reward2";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_Reward2.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_Reward2 {
		var obj = new UI_Reward2();
		if(component==null){component = UI_Reward2.CreateComponent(WorldContextObject);}
