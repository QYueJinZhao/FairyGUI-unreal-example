...
export default class UI_Reward1 {
	...
	public static URL:string = "ui://h9dczuj89xrpl";
	public static Package:string  = "SignIn";
	public static Component:string  = "Reward1";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_Reward1.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_Reward1 {
		var obj = new UI_Reward1();
		if(component==null){component = UI_Reward1.CreateComponent(WorldContextObject);}
