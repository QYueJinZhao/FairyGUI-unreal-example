...
export default class UI_Reward5 {
	...
	public static URL:string = "ui://h9dczuj89xrpp";
	public static Package:string  = "SignIn";
	public static Component:string  = "Reward5";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_Reward5.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_Reward5 {
		var obj = new UI_Reward5();
		if(component==null){component = UI_Reward5.CreateComponent(WorldContextObject);}
