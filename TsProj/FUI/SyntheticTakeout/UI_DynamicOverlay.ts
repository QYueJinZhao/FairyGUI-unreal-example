...
export default class UI_DynamicOverlay {
	...
	public m_T7:UI_T7;
	public m_T8:UI_T8;
	public static URL:string = "ui://tqsc8htvwfi03s";
	public static Package:string  = "SyntheticTakeout";
	public static Component:string  = "DynamicOverlay";
	public view : fgui.GComponent;

	public static  CreateComponent(WorldContextObject: fgui.Object):fgui.GComponent {
		return fgui.UIPackage.CreateObjectFromURL(UI_DynamicOverlay.URL, WorldContextObject, fgui.GComponent.StaticClass()) as fgui.GComponent;
	}

	public static createInstance(component:fgui.GComponent, WorldContextObject: fgui.Object):UI_DynamicOverlay {
		var obj = new UI_DynamicOverlay();
		if(component==null){component = UI_DynamicOverlay.CreateComponent(WorldContextObject);}
