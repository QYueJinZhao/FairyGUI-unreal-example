...
class UI_DynamicOverlay {
    ...
    m_T7;
    m_T8;
    static URL = "ui://tqsc8htvwfi03s";
    static Package = "SyntheticTakeout";
    static Component = "DynamicOverlay";
    view;
    static CreateComponent(WorldContextObject) {
        return fgui.UIPackage.CreateObjectFromURL(UI_DynamicOverlay.URL, WorldContextObject, fgui.GComponent.StaticClass());
    }
    static createInstance(component, WorldContextObject) {
        var obj = new UI_DynamicOverlay();
        if (component == null) {
            component = UI_DynamicOverlay.CreateComponent(WorldContextObject);
        }
...
exports.default = UI_DynamicOverlay;
//# sourceMappingURL=UI_DynamicOverlay.js.map