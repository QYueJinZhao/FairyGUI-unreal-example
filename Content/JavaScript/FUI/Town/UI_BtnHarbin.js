...
class UI_BtnHarbin {
    ...
    m_Overview;
    m_t0;
    static URL = "ui://7d8qawjuq131i";
    static Package = "Town";
    static Component = "BtnHarbin";
    view;
    static CreateComponent(WorldContextObject) {
        return fgui.UIPackage.CreateObjectFromURL(UI_BtnHarbin.URL, WorldContextObject, fgui.GComponent.StaticClass());
    }
    static createInstance(component, WorldContextObject) {
        var obj = new UI_BtnHarbin();
        if (component == null) {
            component = UI_BtnHarbin.CreateComponent(WorldContextObject);
        }
...
exports.default = UI_BtnHarbin;
//# sourceMappingURL=UI_BtnHarbin.js.map