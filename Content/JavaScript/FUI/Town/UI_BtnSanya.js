...
class UI_BtnSanya {
    ...
    m_Overview;
    m_t0;
    static URL = "ui://7d8qawjuq131h";
    static Package = "Town";
    static Component = "BtnSanya";
    view;
    static CreateComponent(WorldContextObject) {
        return fgui.UIPackage.CreateObjectFromURL(UI_BtnSanya.URL, WorldContextObject, fgui.GComponent.StaticClass());
    }
    static createInstance(component, WorldContextObject) {
        var obj = new UI_BtnSanya();
        if (component == null) {
            component = UI_BtnSanya.CreateComponent(WorldContextObject);
        }
...
exports.default = UI_BtnSanya;
//# sourceMappingURL=UI_BtnSanya.js.map