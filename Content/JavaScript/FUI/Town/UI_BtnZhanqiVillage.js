...
class UI_BtnZhanqiVillage {
    ...
    m_Overview;
    m_t0;
    static URL = "ui://7d8qawjuq131g";
    static Package = "Town";
    static Component = "BtnZhanqiVillage";
    view;
    static CreateComponent(WorldContextObject) {
        return fgui.UIPackage.CreateObjectFromURL(UI_BtnZhanqiVillage.URL, WorldContextObject, fgui.GComponent.StaticClass());
    }
    static createInstance(component, WorldContextObject) {
        var obj = new UI_BtnZhanqiVillage();
        if (component == null) {
            component = UI_BtnZhanqiVillage.CreateComponent(WorldContextObject);
        }
...
exports.default = UI_BtnZhanqiVillage;
//# sourceMappingURL=UI_BtnZhanqiVillage.js.map