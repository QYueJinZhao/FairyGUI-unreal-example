...
class UI_AdvertisingCard {
    ...
    m_Title;
    m_Desc;
    static URL = "ui://sn18zihkdkz643";
    static Package = "MainPage";
    static Component = "AdvertisingCard";
    view;
    static CreateComponent(WorldContextObject) {
        return fgui.UIPackage.CreateObjectFromURL(UI_AdvertisingCard.URL, WorldContextObject, fgui.GComponent.StaticClass());
    }
    static createInstance(component, WorldContextObject) {
        var obj = new UI_AdvertisingCard();
        if (component == null) {
            component = UI_AdvertisingCard.CreateComponent(WorldContextObject);
        }
...
exports.default = UI_AdvertisingCard;
//# sourceMappingURL=UI_AdvertisingCard.js.map